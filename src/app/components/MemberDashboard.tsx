  ...
  return (
    <div className="p-4 lg:p-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="p-6 rounded-2xl text-white relative overflow-hidden" style={{ background: "linear-gradient(135deg, #1E2530 0%, #2A3444 100%)" }}>
          ...
          <p className="text-3xl font-bold mb-1" style={{ fontFamily: "Geist Mono, monospace" }}>
            450 000 <span className="text-lg font-normal text-white/70">XAF</span>
          </p>
        ...
        <div className="p-6 rounded-2xl text-white relative overflow-hidden" style={{ background: "linear-gradient(135deg, #4CAF68 0%, #1F9D55 100%)" }}>
          ...
          <p className="text-3xl font-bold mb-1" style={{ fontFamily: "Geist Mono, monospace" }}>
            1 200 000 <span className="text-lg font-normal text-white/70">XAF</span>
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-card rounded-2xl border border-border p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontFamily: "DM Sans, sans-serif" }}>{fr ? "Transactions récentes" : "Recent transactions"}</h3>
              <button onClick={() => navigate("/transactions")} className="text-xs text-[#4CAF68] font-medium flex items-center gap-1 hover:underline">
            ...
            <div className="space-y-1">
              {recentTxns.map((txn) => {
                ...
                return (
                  <div key={txn.id} className="flex items-center gap-3 py-3 border-b border-border last:border-0">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl border border-border p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontFamily: "DM Sans, sans-serif" }}>{fr ? "Objectif principal" : "Main goal"}</h3>
              <button onClick={() => navigate("/savings")} className="text-xs text-[#4CAF68] font-medium hover:underline">{fr ? "Voir tout" : "View all"}</button>
            </div>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-2xl">{mainGoal.icon}</span>
              <div>
                <p className="text-sm font-medium">{mainGoal.name}</p>
          ...
          <div className="bg-card rounded-2xl border border-border p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontFamily: "DM Sans, sans-serif" }}>{fr ? "Ma Tontine" : "My Tontine"}</h3>
              <button onClick={() => navigate("/tontines")} className="text-xs text-[#4CAF68] font-medium hover:underline">{fr ? "Voir" : "View"}</button>
            </div>
